                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group" style="margin-top: 15px;">
                                        ...
                                        <select name="type" class="form-control unicase-form-control text-input" id="usertype">
                                            ...
                                            <option <?php if( $user->role_name=='buyer' ){ echo "selected=''"; }?> value="buyer">Indvidual Seller</option>
                                            <option <?php if( $user->role_name=='seller' ){ echo "selected=''"; }?> value="seller">Wholesale Seller</option>
                                        </select>
                                    </div>
                                    <div class="register_form" style="display: none;">
                                        <form action="{{ route('User.update',$user->id) }}" class="register-form" role="form" method="post" accept-charset="utf-8">
                                            @csrf
                                            @method('put')
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group form-user">
                                                        ...
                                                        <input type="text" name="buyer_name" value="{{ $user->name }}"  class="form-control" id="name" />
                                                        @error('buyer_name')
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group form-user">
                                                        ...
                                                        <input type="text" name="buyer_company" value="{{ $user->company }}"  class="form-control " id="Company" />
                                                        @error('buyer_company')
                                                            <p class="text-danger mt-0-5">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group form-user">
                                                        ...
                                                        <input type="text" name="buyer_phone" value="{{ $user->phone }}" maxlength="11"  class="form-control" id="phone" />
                                                            @error('buyer_phone')
                                                                <p class="text-danger mt-0-5">{{ $message }}</p>
                                                            @enderror
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group form-user">
                                                        ...
                                                        <input type="email" id="email" name="buyer_email" value="{{ $user->email }}" class="form-control" style="margin:0;"/>
                                                            @error('buyer_email')
                                                                <p class="text-danger mt-0-5">{{ $message }}</p>
                                                            @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group form-user">
                                                        ...
                                                        <input type="text" name="buyer_username" value="{{ $user->username }}"  class="form-control " id="username" />
                                            ...
                                            <button type="submit" class="btn-upper btn btn-primary checkout-page-button">Update User</button>
                                        </form>                            
                                    </div>
                                        ...
                                        <form action="{{ route('User.update',$user->id) }}" class="register-form " role="form" method="post" accept-charset="utf-8">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="username" value="{{ $user->username }}"  class="form-control unicase-form-control text-input" id="full_name"/>
                                                    @error('username')
                                                            <p class="text-danger mt-0-5">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="name" value="{{ $user->name }}"  class="form-control unicase-form-control text-input" id="full_name"/>
                                                    @error('name')
                                                            <p class="text-danger mt-0-5">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row">
                                                 <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="shop" value="{{ $user->shop }}"  class="form-control unicase-form-control text-input" id="code"  />
                                                    @error('shop')
                                                            <p class="text-danger mt-0-5">{{ $message }}</p>
                                                    @enderror
                                                </div>
