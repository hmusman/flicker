        ...
        <div class="page-content">
            ...
            <div class="page-title-box">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Update Welcome Email</h4>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12">
                            <form action="{{ route('Welcome.Email.update',$content->id) }}" method="post">
                                @csrf
                                <div class="card">
                                    <div class="card-body">

                                        <h4 class="header-title">Update Welcome Email </h4>
                                        @if(Session::has('msg'))
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <textarea name="content" id="textarea" class="form-control tinymce-classic" placeholder="Please Type Description...">{{ $content->content }}</textarea>
                                                 @error('content')
