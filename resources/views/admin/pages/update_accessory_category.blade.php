        ...
        <div class="page-content">
            ...
            <div class="page-title-box">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Update Accessory Category</h4>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12">
                            <form action="{{ route('AccessoryCategory.update',$category->id) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="card">
                                    <div class="card-body">

                                        <h4 class="header-title">Update Accessory Category</h4>
