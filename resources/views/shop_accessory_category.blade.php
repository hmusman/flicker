...
<script type="text/javascript">
  $(document).ready(function(){
      $('#ResetFilter').click(function(){
          ...
          FetchData(0,'{{ $accessorycategory->id }}');
      });
      ...
      function BrandPriceAccessories()
      {
          if($('#brand').children("option:selected").val() !='Brands' && $('#price'). children("option:selected").val() !='Price')
          {
            if($('#view').children('option:selected').val() =="Select View")
            {
              ...
              var nView = 9;
              FetchBrandPriceAccessories(0,'{{ $accessorycategory->id }}',brand,price,nView);
            }
            else
            {
              ...
              var brand = $('#brand').children("option:selected").val();
              var price = $('#price').children("option:selected").val();
              FetchBrandPriceAccessories(0,'{{ $accessorycategory->id }}',brand,price,view);
            }
      ...
      $('#brand').change(function(){
          if($('#price'). children("option:selected").val() =='Price')
          {
            ...
            { 
              ...
              FetchBrandAccessories(0,'{{ $accessorycategory->id }}',id,9);
            }
            else
            {
              var nView = $('#view').children('option:selected').val();
              var id = $('#brand').children("option:selected").val();
              FetchBrandAccessories(0,'{{ $accessorycategory->id }}',id,nView);
            }
      ...
      $('#view').change(function(){
          ...
          {
              var nView = $('#view').children('option:selected').val();
              FetchNViewAccessories(0,'{{ $accessorycategory->id }}',nView);
          }
          else if($('#brand').children("option:selected").val() !='Brands' && $('#price'). children("option:selected").val() =='Price')
          {
            var brand = $('#brand').children("option:selected").val();
            var nView = $('#view').children("option:selected").val();
            FetchBrandAccessories(0,'{{ $accessorycategory->id }}',brand,nView);
          }
          else if($('#brand'). children("option:selected").val() =='Brands' && $('#price'). children("option:selected").val() !='Price' && $('#view').children('option:selected').val() !="Select View")
          {
            var price = $('#price').children("option:selected").val();
            var view = $('#view').children("option:selected").val();
            FetchPriceAccessories(0,'{{ $accessorycategory->id }}',price,view);         
          }
          else
          {BrandPriceAccessories()};  
      });
      ...
      $('#price').change(function(){
          if($('#brand').children("option:selected").val() =='Brands')
          {
            ...
            {
              var price = $('#price').children("option:selected").val();
              FetchPriceAccessories(0,'{{ $accessorycategory->id }}',price,9);
            }
            else
            {
              var nView = $('#view').children('option:selected').val();
              var price = $('#price').children("option:selected").val();
              FetchPriceAccessories(0,'{{ $accessorycategory->id }}',price,nView);
            }
      ...
      $(document).on('click', '.pagination a', function(event){
          ...
          {
            var brand = $('#brand').children("option:selected").val();
            FetchBrandAccessories(page,'{{ $accessorycategory->id }}',brand,9);
          }

          else if($('#brand'). children("option:selected").val() =='Brands' && $('#price'). children("option:selected").val() !='Price' && $('#view').children('option:selected').val() =="Select View")
          {
            var price = $('#price').children("option:selected").val();
            FetchPriceAccessories(page,'{{ $accessorycategory->id }}',price,9);
          }
          ...
          else if($('#brand'). children("option:selected").val() !='Brands' && $('#price'). children("option:selected").val() !='Price' && $('#view').children('option:selected').val() =="Select View")
          {
            var brand = $('#brand').children("option:selected").val();
            var price = $('#price').children("option:selected").val();
            FetchBrandPriceAccessories(page,'{{ $accessorycategory->id }}',brand,price,9);         
          }
          ...
          else if($('#brand'). children("option:selected").val() =='Brands' && $('#price'). children("option:selected").val() !='Price' && $('#view').children('option:selected').val() !="Select View")
          {
            ...
            var price = $('#price').children("option:selected").val();
            var view = $('#view').children("option:selected").val();
            FetchBrandPriceAccessories(page,'{{ $accessorycategory->id }}',price,view);         
          }

          else if($('#brand'). children("option:selected").val() =='Brands' && $('#price'). children("option:selected").val() =='Price' && $('#view').children('option:selected').val() !="Select View")
          {
            var view = $('#view').children("option:selected").val();
            FetchNViewAccessories(page,'{{ $accessorycategory->id }}',view);         
          }

          else if($('#brand'). children("option:selected").val() =='Brands' && $('#price'). children("option:selected").val() =='Price' && $('#view').children('option:selected').val() =="Select View")
          {
            FetchData(page,'{{ $accessorycategory->id }}');            
          }
         });
         ...
         {
          $.ajax({
           url:"/pagination/accessory_category_fetch_data?page="+page,
           type:"get",
           data:{id:id},
           success:function(data)
           {
         ...
         function FetchBrandAccessories(page,category_id,id,nView)
         {
          $.ajax({
           url:"/NewShopBrandAccessories?page="+page,
           type:"get",
           data:{category_id:category_id,id:id,nView:nView},
           success:function(data)
           {
            $('.products').html(data);
           }
         ...
         function FetchNViewAccessories(page,category_id,nView)
         {
          $.ajax({
           url:"/NewShopViewAccessories?page="+page,
           type:"get",
           data:{category_id:category_id,nView:nView},
           success:function(data)
           {
            $('.products').html(data);
           }
         ...
         function FetchPriceAccessories(page,category_id,price,nView)
         {
            $.ajax({
             url:"/NewShopPriceAccessories?page="+page,
             type:"get",
             data:{category_id:category_id,price:price,nView:nView},
             success:function(data)
             {
              $('.products').html(data);
             }
         ...
         function FetchBrandPriceAccessories(page,category_id,id,price,nView)
         {
          $.ajax({
           url:"/NewShopBrandPriceAccessories?page="+page,
           type:"get",
           data:{category_id:category_id,brand:id,price:price,nView:nView},
           success:function(data)
           {
            $('.products').html(data);
           }
