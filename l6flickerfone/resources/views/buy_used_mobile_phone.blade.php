...
<div class="clearfix"></div>
    ...
    <div class="products"><div class="row buyleft">
      <a href="https://flickerfone.com/buyproductdetails/42">
      </a><div class="col-xs-12 mainboxbuy"><a href="https://flickerfone.com/buyproductdetails/42">
        <div class="col-sm-3" align="center">
            <img class="img-responsive img-thumbnail" src="https://flickerfone.com/assets/uploads/thumbs/c0b00f960239159c7a9665f068fac801.jpg">
        </div>
        </a><div class="col-sm-9"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/42">
            <h3 id="buytextmain" style="font-size:20px;">Apple iphone x Black 64 GB  </h3>

            <p>dlkbjoidfv</p>
            <div class="clearfix"></div>
          </a><div class="row buymargintop"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/42">
            <div class="col-sm-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <p class="buyprice">PKR  50,000</p>
            ...
            </a><div class=" col-sm-8 col-md-8 col-lg-8"><a  style="color: black !important;" href="https://flickerfone.com/buyproductdetails/42">
                <table>
                  <tbody><tr>
    ...
    </div><div class="row buyleft">
      <a href="https://flickerfone.com/buyproductdetails/41">
      </a><div class="col-xs-12 mainboxbuy"><a href="https://flickerfone.com/buyproductdetails/41">
        <div class="col-sm-3" align="center">
            <img class="img-responsive img-thumbnail" src="https://flickerfone.com/assets/uploads/thumbs/8beeaa88614dee924078ebda6b3472f1.jpg">
        </div>
        </a><div class="col-sm-9"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/41">
            <h3 id="buytextmain" style="font-size:20px;">Alcatel jabi=ong Green 4 GB  </h3>

            <p>No</p>
            <div class="clearfix"></div>
          </a><div class="row buymargintop"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/41">
            <div class="col-sm-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <p class="buyprice">PKR  25,550</p>
            <table class="table-bordered"><tbody><tr><td style="padding:5px;color:#444;background:#e0e0e1;">Fair</td><td style="padding:5px;color:#444;background:#e0e0e1;">Good</td><td style="padding:5px;background:#028f63;color:#fff;">Excellent</td></tr></tbody></table></div>
            </a><div class=" col-sm-8 col-md-8 col-lg-8"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/41">
                <table>
                  <tbody><tr>
                    <td><b>Negotiable: </b> </td>
                    <td><b>Yes</b></td>
                  ...
                  <tr>
                    <td>Posted Date:</td>
                    <td>2019-12-23 18:37:32</td>
                  </tr>
                </tbody></table>
                </a><a style="color: black !important;" href="productDetail2.html">
                <button class="btn-xs button3 buydetailsbtn">Contact / Details</button>
                </a>
            </div>
          </div>
      ...
      <a href="https://flickerfone.com/buyproductdetails/40">
      </a><div class="col-xs-12 mainboxbuy"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/40">
        <div class="col-sm-3" align="center">
            <img class="img-responsive img-thumbnail" src="https://flickerfone.com/assets/uploads/thumbs/8e3d369ed8c9114bd977c8c6fbf39417.jpg">
        </div>
        </a><div class="col-sm-9"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/40">
            <h3 id="buytextmain" style="font-size:20px;">Apple VIVO Y15 Gold 16 GB  </h3>

            <p>SALE IT</p>
            <div class="clearfix"></div>
          </a><div class="row buymargintop"><a href="https://flickerfone.com/buyproductdetails/40">
            <div class="col-sm-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <p class="buyprice">PKR  90,000</p>
            <table class="table-bordered"><tbody><tr><td style="padding:5px;background:#028f63;color:#fff;">Fair</td><td style="padding:5px;color:#444;background:#e0e0e1;">Good</td><td style="padding:5px;color:#444;background:#e0e0e1;">Excellent</td></tr></tbody></table></div>
            </a><div class=" col-sm-8 col-md-8 col-lg-8"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/40">
                <table>
                  <tbody><tr>
                    <td><b>Negotiable: </b> </td>
                    <td><b>Yes</b></td>
                  ...
                  <tr>
                    <td>Posted Date:</td>
                    <td>2019-10-21 07:10:34</td>
                  </tr>
                </tbody></table>
                </a><a href="productDetail3.html">
                <button class="btn-xs button3 buydetailsbtn">Contact / Details</button>
                </a>
            </div>
          </div>
      ...
      <a href="https://flickerfone.com/buyproductdetails/39">
      </a><div class="col-xs-12 mainboxbuy"><a href="https://flickerfone.com/buyproductdetails/39">
        <div class="col-sm-3" align="center">
            <img class="img-responsive img-thumbnail" src="https://flickerfone.com/assets/uploads/thumbs/cb3fcb5087216645191695faac3dec3c.jpg">
        </div>
        </a><div class="col-sm-9"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/39">
            <h3 id="buytextmain" style="font-size:20px;">HTC Play 2 Black 4 GB  </h3>

            <p>i really want to sell my device</p>
            <div class="clearfix"></div>
          </a><div class="row buymargintop"><a style="color: black !important;" href="https://flickerfone.com/buyproductdetails/39">
            <div class="col-sm-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <p class="buyprice">PKR  1,000</p>
            </div>
            </a><div class=" col-sm-8 col-md-8 col-lg-8"><a  style="color: black !important;" href="https://flickerfone.com/buyproductdetails/39">
                <table>
                  <tbody><tr>
                    <td><b>Negotiable: </b> </td>
                    <td><b>Yes</b></td>
                  ...
                  <tr>
                    <td>Posted Date:</td>
                    <td>2019-10-21 01:30:48</td>
                  </tr>
                </tbody></table>
                </a><a style="color: black !important;" href="productDetail4.html">
                <button class="btn-xs button3 buydetailsbtn">Contact / Details</button>
                </a>
            </div>
          </div>
