<title>Flicker Fone</title>
 ...
 <link rel="stylesheet" type="text/css" href="{{ asset('css/slick.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('css/Notiser0.css') }}">
      <link rel="stylesheet" href="{{ asset('css/Notiser.css') }}">
  ...
  <link rel="stylesheet" href="index.html">
        ...
        <link href="{{ asset('css/thumbelina.css') }}" rel="stylesheet">
