                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="" type="button" class="btn btn-outline-secondary btn-sm view" data-placement="top" title="" data-original-title="View" data-toggle="modal" data-target="#detail" data-uname="{{$admin->name}}" data-email="{{$admin->email}}">
