    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Product Opinions</h4>
                </div>
                <div class="col-md-4">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
							<h4 class="header-title">All Opinions</h4>
                            @if(Session::has('msg'))
							...
							<table id="datatable" class="mt-3 table table-bordered table-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('Admin.ProductOpinionReplies',$opinion->id) }}">{{ $opinion->replies->count() }}</a></td>
                                        <td>
                                            <table>
                                               <tr>
                                                   <td>
