            ...
            <div class="page-title-box">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Add FlickerFone Meta</h4>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title">Add New Meta</h4>
                                    ...
                                    <form action="{{ route('Meta.store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="page">
                                                    ...
                                                    @foreach($pages as $page)
                                                        <option <?php if(old('page')==$page->id){ echo "selected=''"; } ?>  value="{{ $page->id }}">{{ ucfirst($page->name) }}</option>
                                                    @endforeach
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea id="textarea" class="form-control" rows="5" name="content" placeholder="Please Type Detail...">{{ old('content') }}</textarea>
                                                @error('content')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
