        ...
        <div class="page-content">
            ...
            <div class="page-title-box">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Update FlickerFone IndexBuyNewSell Section</h4>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12">
                            <form action="{{ route('IndexBuyNewSellSection.update',$data->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row" style="display: none;">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" name="title" type="text" value="{{ $data->title }}" placeholder="Enter Name" id="example-text-input">
                                                @error('title')
